...
import UnifiedTimerDisplay from './components/UnifiedTimerDisplay.jsx';
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-slate-200 dark:border-slate-700">
          <div className="flex items-center gap-3 text-xs text-slate-600 dark:text-slate-400 flex-wrap">
            ...
            <UnifiedTimerDisplay countdown={estimatedCountdown} task={task} />
            ...
            <div className="flex items-center gap-2">
              ...
              {onEdit && (
                <Button
                  ...
                  className="text-amber-600 hover:bg-amber-50 dark:text-amber-400 dark:hover:bg-amber-950"
                  title="Edit task"
                >
                  ✏️
                </Button>
